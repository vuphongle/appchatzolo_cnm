...
import { View, Text, TouchableOpacity, Image, Switch, ScrollView, Alert, StyleSheet } from 'react-native';
import { Dialog, Portal, Provider, Button, TextInput } from 'react-native-paper';
        ...
        <View style={styles.profileSection}>
            ...
            <View style={styles.quickActions}>
                ...
                <QuickActionButton
                    ...
                    onPress={() => Alert.alert("Thành viên", `${chatData.members.length} thành viên`)}
                />
        ...
        <Provider>
            <View style={styles.container}>
                ...
                <ScrollView>
                    ...
                    >
                        <MaterialCommunityIcons name="star-outline" size={24} color="#828282" />
                        <Text style={styles.settingsItemText}>Đánh dấu bạn thân</Text>
                        <Switch value={isBFF} onValueChange={setIsBFF} style={{ marginLeft: 150 }} />
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => setIsBFF(!isBFF)}
                    >
                        <MaterialCommunityIcons name="clock-outline" size={24} color="#828282" />
                        <Text style={styles.settingsItemText}>Nhật ký chung</Text>
                        <Ionicons name="chevron-forward-outline" size={24} color="#828282" style={{ marginLeft: 200 }} />
                    </TouchableOpacity>
                    {MOCK_USER._id === chatData.owner && (
                        <TouchableOpacity
