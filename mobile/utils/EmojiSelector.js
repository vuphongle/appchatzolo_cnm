...
const EmojiSelector = ({ onEmojiSelected, columns = 6, showSearchBar = true, showTabs = true, showHistory = true, placeholder = 'Tìm kiếm emoji...' }) => {
  ...
  const handleEmojiPress = (emoji) => {
    ...
    if (showHistory) {
      const updatedHistory = [emoji, ...emojiHistory.filter(e => e !== emoji)].slice(0, 20);
