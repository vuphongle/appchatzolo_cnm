...
const ConfirmSignUpScreen = () => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Thành công',
        'Xác thực số điện thoại thành công. Đang tạo tài khoản...',
      );
      ...
      Alert.alert(
        'Thành công',
        'Xác thực số điện thoại thành công. Đang lưu thông tin người dùng...',
      );
      ...
      try {
        ...
        Alert.alert(
          'Thành công',
          'Đăng ký và lưu thông tin người dùng thành công.',
        );
        ...
        Alert.alert(
          'Lỗi',
          'Xác thực thành công nhưng không thể lưu thông tin người dùng. Vui lòng liên hệ hỗ trợ.',
        );
      }
    } catch (error) {
      ...
      if (
        error.code === 'VerificationException' &&
        error.message.includes('Verification code is incorrect')
      ) {
